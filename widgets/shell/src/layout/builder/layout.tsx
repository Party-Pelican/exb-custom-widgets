...
import { ItemTitle } from "../common/layout-title";
...
class Layout
  extends React.PureComponent<LayoutProps & StateToLayoutProps, State>
  implements DropHandlers
{
        ...
        {(props: PageContextProps) => {
          ...
          return (
            ...
            >
              ...
              />
              {(content as any).map((layoutItemId) =>
                this.createItem(layoutItemId)
              )}
              <canvas
                css={guideOverlay}
